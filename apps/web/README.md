...
[API 라우트](https://nextjs.org/docs/app/building-your-application/routing/router-handlers)를 추가하려면 `app/` 아래에 `api/` 디렉터리와 `route.ts`를 둡니다. 예: `api/hello/route.ts` → [http://localhost:3001/api/hello](http://localhost:3001/api/hello).
